...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.Check				"000 255 000 255"			//urik: changed white to green // color of the check itself
	...
	// Custom styles for use with L4D360HybridButtons
		...
		HybridButton.BorderColor					"000 255 255 255"//selected1color	urik: this the border color for l4d2 hubrid buttons (all menu/submenu selections). This... should be brighter than BlotchColor (selected2color)
		HybridButton.BlotchColor					"000 255 255 050"//selected2color	urik: this the inside-fill color for l4d2 hubrid buttons (all menu/submenu selections). This... should be darker (or, perhaps, more transparent) than BorderColor (selected1color)
	...
	Fonts
	{
		"Default"
		{
			"1"
			{
				...
				"weight"	"400"
				"antialias"	"1"
				////"scanlines"	"1"//Urik: added scanlines
			}
		}
		...
		"BlogPostText"
		{
			...
			{
				"name"		"Tahoma"			[$WIN32]
				"name"		"tahoma"		[($X360WIDE && $X360HIDEF)]
				"name"		"tahoma" [!($X360WIDE && $X360HIDEF)]
				"tall"		"14"
				"weight"	"400"
				"antialias"	"1"
